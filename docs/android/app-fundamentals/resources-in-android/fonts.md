...
当请求下载字体时，应用不会直接查询字体提供程序。 相反，应用程序将使用[`FontsContract`](https://developer.android.com/reference/android/provider/FontsContract.html) API 的实例（ [`FontsContractCompat`](https://developer.android.com/reference/android/support/v4/provider/FontsContractCompat.html)如果使用的是支持库26）。  
