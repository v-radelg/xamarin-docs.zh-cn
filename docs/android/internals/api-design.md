...
- [util\<E >](https://developer.android.com/reference/java/util/Collection.html)映射到系统类型[\<ICollection T >](xref:System.Collections.Generic.ICollection`1)，帮助程序类[JavaCollection\<t >](xref:Android.Runtime.JavaCollection`1)。
