...
从7月31日开始，我们已将 iOS 示例的端口发布到了[monotouch.dialog](https://github.com/xamarin/monotouch-samples/commits/magic-types)上 `magic-types` 分支上的新 API。
