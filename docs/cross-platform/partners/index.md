...
| 合作伙伴 | 位置 | 描述 |
| --- | --- | --- |
|[3factr](http://3factr.be/)|Edegem，比利时|3factr 是 100%，侧重于带有 divers API 集成的 Xamarin Mobile 开发。 Theyprovide 将这两种咨询作为 Xamarin iOS、Android 和 UWP 应用的软件工厂内部开发。|
...
|[适用于企业的橙色应用程序](http://www.orange-business.com/en/contact-us)|巴黎，法国;瑞士苏黎世|橙色业务服务是全球电信运营商和 IT 服务公司。 其20000员工在其数字转换的每个方面都支持公司、当地政府机构和公共部门组织。 它们可帮助公司更有效地进行协作，更高效地进行协作， &ndash;更好地与客户、网络和计算机的客户安全可靠地合作。|
...
| 合作伙伴 | 位置 | 描述 |
| --- | --- | --- |
|[Unissoft 技术有限公司。](http://www.inas.online/en/Index.php)|香港特别行政区|我们的核心技术 Tsing Hua 存档管理软件（™或较短的）是中国的状态存档管理的建议产品，因此，政府和多个行业也广泛使用了这些技术，包括石油和化学;在不同的企业中，例如灌溉 works、metallurgy、电信和房地产---通过传统的本地许可模式。 |
...
|[Sistemas Vass Consultoria](http://www.vass.es/en)|巴塞罗纳马德里;西班牙巴塞罗纳|VASS 是一家 IT 咨询公司，成立于1999，通过一项全面的知识和精通的技术，在新技术和集成的产品和服务方面实现了高度专门化。 他们是一家公司，在欧洲和美国的几个国家/地区提供对国际扩展的明确承诺。 VASS 是一家公司，致力于向社会活动支出 2% 的利润。|
...
| 合作伙伴 | 位置 | 描述 |
| --- | --- | --- |
|[iScreen 公司](http://www.iscreen.com)|台北，中国台湾|iScreen 在坚实的技术基础之上构建了基础，并注重于咨询、设计和构建 Web 以及任何移动平台应用|
|[JetFusion 信息](http://www.jetfusion.com.tw/)|中国台北|我们提供高度灵活、实时的专业软件开发和系统建设服务，还提供完整的企业信息系统解决方案。|
...
|[Zepto 系统有限](http://www.zeptosystems.com )|英国伦敦|将外包和 offshoring 转换为智能来源。 通过远程员工提高内部容量和技能，节省时间、成本（高达 60%）、雇佣和留住。|
