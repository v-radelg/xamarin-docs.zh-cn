...
[在 PCL 的 System.IO 类中 ![Intellisense 14 类的列表](pcl-images/image6.png)](pcl-images/image6.png#lightbox)
...
[![Add 通过编辑引用选项对 PCL 的引用](pcl-images/image8.png)](pcl-images/image8.png#lightbox)
...
[![Edit 平台目标](pcl-images/image13-sml.png)](pcl-images/image13.png#lightbox)
...
[PCL 中可用的 ![Reduced IO 类数](pcl-images/image14.png)](pcl-images/image14.png#lightbox)

将其与常规项目中的 System.IO 自动完成进行比较–存在40个类，其中包括 `File` 和 `Directory` 等常用类，这些类不在任何 PCL 配置文件中。

[![Many 多个 .NET Framework 中可用的 IO 类](pcl-images/image15.png)](pcl-images/image15.png#lightbox)
...
[通过 "添加引用项目" 选项卡 ![Add 对 PCL 的引用](pcl-images/image16.png)](pcl-images/image16.png#lightbox)
