...
最后，使用**插座**向代码公开**文本视图**（确保选择 `ViewController.h` 文件）：
...
- [macOS 设计主题（Apple）](https://developer.apple.com/design/human-interface-guidelines/macos/overview/themes/)
- [Windows、面板和屏幕（Apple）](https://developer.apple.com/documentation/appkit/windows_panels_and_screens)
