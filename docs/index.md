                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">开始操作</h3>
                                    <p>生成适用于 Android、iOS 和 UWP 的应用。</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>用户界面</h3>
                                                    <p>了解跨 Android、iOS 和 Windows 可用的 UI 控件。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Android 入门</h3>
                                                    <p>通过 Xamarin.Android 启动和运行的相关教程。 请确保正确安装所有项目，并生成首个应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Android 用户界面</h3>
                                                    <p>了解可在 Android 上使用的用户界面小组件的完整集合。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Android 平台功能</h3>
                                                    <p>使用特定于平台的功能和 Android 最新的新增功能。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>示例应用</h3>
                                                    <p>帮助你启动和运行的 Android 手机和平板电脑示例。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>iOS 入门</h3>
                                                    <p>通过 Xamarin.iOS 启动和运行的相关教程。 请确保正确安装所有项目，并生成首个应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>iOS 用户界面</h3>
                                                    <p>了解在 iOS 上可用的 UIKit 控件的完整集合。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>iOS 平台功能</h3>
                                                    <p>使用特定于平台的功能，如 FaceID 和 ARKit，以及 iOS 的最新新增功能。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>示例应用</h3>
                                                    <p>适用于 iPhone、iPad、Apple Watch 和 Apple TV 的应用和代码演示。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mac 入门</h3>
                                                    <p>通过 Xamarin.Mac 启动和运行的相关教程。 请确保正确安装所有项目，并生成首个应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mac 用户界面</h3>
                                                    <p>了解在 macOS 上可用的 AppKit 控件的完整集合。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>示例应用</h3>
                                                    <p>帮助你开始进行面向 Mac 桌面设备的 C# 开发的 macOS 示例应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>共享代码</h3>
                                                    <p>了解在 Android、iOS 和 Windows 之间共享代码和库的不同选项。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>语言支持</h3>
                                                    <p>Xamarin 项目可以用 C# 和 F# 进行编写，并能使用通过 VB 编写的库。 此外，还支持 Razor 模板。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
