...
##### [自动预配](get-started/installation/device-provisioning/automatic-provisioning.md)
##### [手动预配](get-started/installation/device-provisioning/manual-provisioning.md)
##### [免费预配](get-started/installation/device-provisioning/free-provisioning.md)
...
### [面向 Objective-C 开发者的 Xamarin](get-started/objective-c-developers/index.md)
#### [面向 Objective-C 开发人员的 C# 入门](get-started/objective-c-developers/primer.md)
## [应用程序基础知识](app-fundamentals/index.md)
### [可访问性](app-fundamentals/accessibility.md)
...
#### [备用应用图标](app-fundamentals/images-icons/alternate-app-icons.md)
...
### [线程](app-fundamentals/threading.md)
...
#### [映射](user-interface/controls/ios-maps/index.md)
...
#### [进度和活动指标器](user-interface/controls/progress-activity-indicator.md)
...
#### [开始操作](platform/introduction-to-ios12/get-started.md)
#### [ARKit 2](platform/introduction-to-ios12/arkit2.md)
#### [Siri 快捷方式](platform/introduction-to-ios12/siri-shortcuts.md)
...
### [文件压缩](platform/file-compression.md)
...
### [文件系统帮助程序](~/essentials/file-system-helpers.md?context=xamarin/ios)
...
### [映射](~/essentials/maps.md?context=xamarin/ios)
...
##### [步骤 1。 寄存器](~/cross-platform/data-cloud/active-directory/get-started/register.md?context=xamarin/ios)
##### [步骤 2。 配置](~/cross-platform/data-cloud/active-directory/get-started/configure.md?context=xamarin/ios)
#### [访问图形 API](~/cross-platform/data-cloud/active-directory/graph.md?context=xamarin/ios)
...
##### [钱包功能](deploy-test/provisioning/capabilities/wallet-capabilities.md)
...
### [使用 Instruments 分析 Xamarin.iOS 应用程序](deploy-test/using-instruments-to-detect-native-leaks-using-markheap.md)
...
### [疑难解答指南](troubleshooting/troubleshooting.md)
...
#### [了解 watchOS](watchos/get-started/hello-watch.md)
...
#### [图像](watchos/user-interface/image.md)
#### [表](watchos/user-interface/table.md)
...
#### [了解 tvOS 快速入门指南](tvos/get-started/hello-tvos.md)
...
#### [tvOS 12 简介](tvos/platform/introduction-to-tvos12/index.md)
