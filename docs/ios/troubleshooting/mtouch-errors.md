...
### <a name="mt0065-xamarinios-only-supports-embedded-frameworks-when-deployment-target-is-at-least-80-current-deployment-target--embedded-frameworks-"></a>MT0065:当部署目标至少为8.0 （当前部署目标： * embedded framework： *）时，Xamarin 仅支持嵌入式框架
