...
在 iOS 6 中, 传入的推送通知告知系统向用户通知应用程序中发生了一些有趣的事情。 单击该通知会将应用程序从 "挂起" 或 "已终止" 状态拉出, 应用将开始更新内容。 iOS 7 (及更高版本) 通过为应用程序提供一种在后台更新内容的机会来扩展普通推送通知, 以便用户可以打开应用程序并立即显示新内容。
