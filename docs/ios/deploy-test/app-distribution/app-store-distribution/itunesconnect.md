...
自定义企业到企业应用程序不面向教育机构或普通 App Store 客户。 若要深入了解 *App Store 批量购买计划商业版*，请访问 Apple 的[常见问题解答](https://vpp.itunes.apple.com/faq)页面。 若要深入了解客户如何注册**批量购买计划**，请访问 Apple 的[部署计划](https://enroll.vpp.itunes.apple.com)页面。
