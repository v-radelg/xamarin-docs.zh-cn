...
[NSLinguisticTagger](xref:Foundation.NSLinguisticTagger)类是仍然可用。 但是，自然语言框架是使用自然语言处理的首选的机制。

## <a name="sample-app-xamarinnl"></a>应用程序示例：XamarinNL
