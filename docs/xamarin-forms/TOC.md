...
### [单页快速入门](~/get-started/quickstarts/single-page.md)
### [多页快速入门](~/get-started/quickstarts/multi-page.md)
### [本地数据库快速入门](~/get-started/quickstarts/database.md)
...
#### [XAML 预览程序](xaml/xaml-previewer/index.md)
##### [设计时数据](xaml/xaml-previewer/design-time-data.md)
##### [自定义控件](xaml/xaml-previewer/render-custom-controls.md)
### 命名空间
#### [XAML 命名空间](xaml/namespaces.md)
#### [XAML 自定义命名空间架构](xaml/custom-namespace-schemas.md)
#### [建议的 XAML 命名空间前缀](xaml/custom-prefix.md)
### 其他功能
...
#### [自定义 WebView](app-fundamentals/custom-renderer/hybridwebview.md)
...
#### [可重用 RoundEffect](app-fundamentals/effects/reusable-roundeffect.md)
...
#### [介绍](user-interface/carouselview/introduction.md)
#### [Data](user-interface/carouselview/populate-data.md)
#### [布局](user-interface/carouselview/layout.md)
#### [交互](user-interface/carouselview/interaction.md)
#### [EmptyView](user-interface/carouselview/emptyview.md)
#### [滚动](user-interface/carouselview/scrolling.md)
...
#### [布局](user-interface/collectionview/layout.md)
#### [选择](user-interface/collectionview/selection.md)
#### [EmptyView](user-interface/collectionview/emptyview.md)
#### [滚动](user-interface/collectionview/scrolling.md)
#### [分组](user-interface/collectionview/grouping.md)
...
#### [常用属性、方法和事件](user-interface/controls/common-properties.md)
...
### [显示弹出窗口](user-interface/pop-ups.md)
...
### 布局
#### [概述](user-interface/layouts/index.yml)
#### [选择布局](user-interface/layouts/choose-layout.md)
...
#### [可绑定的布局](user-interface/layouts/bindable-layouts.md)
#### [布局压缩](user-interface/layouts/layout-compression.md)
#### [自定义布局](user-interface/layouts/custom.md)
...
### 映射
#### [概述](user-interface/map/index.md)
#### [初始化和配置](user-interface/map/setup.md)
#### [地图控件](user-interface/map/map.md)
#### [位置和距离](user-interface/map/position-distance.md)
#### [锁定](user-interface/map/pins.md)
#### [多边形和折线](user-interface/map/polygons.md)
#### [地理编码](user-interface/map/geocoder.md)
#### [启动本机映射应用](user-interface/map/native-map-app.md)
...
### [主题设置](user-interface/theming.md)
### [TimePicker](user-interface/timepicker.md)
### [ToolbarItem](user-interface/toolbaritem.md)
### [视觉对象](user-interface/visual/index.md)
#### [材料视觉对象](user-interface/visual/material-visual.md)
#### [创建视觉对象呈现器](user-interface/visual/create.md)
### [可视状态管理器](user-interface/visual-state-manager.md)
### [WebView](user-interface/webview.md)
## 平台功能
### [概述](platform/index.yml)
### Android
#### [概述](platform/android/index.md)
...
#### [SwipeView 轻扫转换模式](platform/android/swipeview-swipetransitionmode.md)
...
#### [SwipeView 轻扫转换模式](platform/ios/swipeview-swipetransitionmode.md)
