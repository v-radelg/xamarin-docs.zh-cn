...
### [可访问性](app-fundamentals/accessibility/index.md)
...
#### [自定义 Entry](app-fundamentals/custom-renderer/entry.md)
...
### [笔势](app-fundamentals/gestures/index.md)
#### [点击](app-fundamentals/gestures/tap.md)
#### [捏放](app-fundamentals/gestures/pinch.md)
#### [平移](app-fundamentals/gestures/pan.md)
#### [轻扫](app-fundamentals/gestures/swipe.md)
### [本地化](app-fundamentals/localization/index.md)
#### [字符串和图像本地化](app-fundamentals/localization/text.md)
...
#### [数据](user-interface/collectionview/populate-data.md)
...
#### [单元](user-interface/controls/cells.md)
### [DataPages](user-interface/datapages/index.md)
#### [开始操作](user-interface/datapages/get-started.md)
...
#### [条目](user-interface/text/entry.md)
...
### [开始操作](~/essentials/get-started.md?context=xamarin/xamarin-forms)
...
### [映射](~/essentials/maps.md?context=xamarin/xamarin-forms)
...
#### [情感识别](data-cloud/cognitive-services/emotion-recognition.md)
...
### [使用 Visual Studio App Center 自动测试](/appcenter/test-cloud/uitest/get-started-xamarin-forms)
