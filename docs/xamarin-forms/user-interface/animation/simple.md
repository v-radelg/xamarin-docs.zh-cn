...
- `ScaleXTo` 对[`VisualElement`](xref:Xamarin.Forms.VisualElement)的[`ScaleX`](xref:Xamarin.Forms.VisualElement.ScaleX)属性进行动画处理。
- `ScaleYTo` 对[`VisualElement`](xref:Xamarin.Forms.VisualElement)的[`ScaleY`](xref:Xamarin.Forms.VisualElement.ScaleY)属性进行动画处理。
...
> [!NOTE]
> 除了[`ScaleTo`](xref:Xamarin.Forms.ViewExtensions.ScaleTo*)方法之外，还提供了 `ScaleXTo` 和 `ScaleYTo` 方法，分别对[`ScaleX`](xref:Xamarin.Forms.VisualElement.ScaleX)和[`ScaleY`](xref:Xamarin.Forms.VisualElement.ScaleY)属性进行动画处理。
