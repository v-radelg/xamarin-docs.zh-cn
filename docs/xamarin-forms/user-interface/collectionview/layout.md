...
[![具有项间距的 CollectionView 的屏幕截图，在 Android](layout-images/vertical-grid-spacing.png "CollectionView 项间距")](layout-images/vertical-grid-spacing-large.png#lightbox "CollectionView 项间距")
