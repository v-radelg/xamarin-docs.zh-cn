...
[![IOS 和 Android 上主题应用的主页的屏幕截图](theming-images/main-page-both-themes.png "主题应用的主页")](theming-images/main-page-both-themes-large.png#lightbox "主题应用的主页")主题应用的 " [iOS 和 Android(theming-images/detail-page-both-themes.png "详细信息\" 页")![上的主题应用的详细信息页的屏幕截图]](theming-images/detail-page-both-themes-large.png#lightbox "主题应用的详细信息页") 
